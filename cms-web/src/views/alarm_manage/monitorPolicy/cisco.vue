...
import { getPort } from 'services/platform/switch'
export default {
  props: {
    resourceType: {
      type: String
  ...
  data() {
    return {
      ...
      searchConfigs: [
        ...
        { type: 'Select', label: '所属平台', value: 'vendorId', data: [], service: { api: getCloudVendor, params: { simple: true, params: this.$tools.handleSearchParam({ type: 'SMIS_FABRIC', authentication: '"projectName":"cisco_nxos"' }) }, attr: 'data.rows' } },
