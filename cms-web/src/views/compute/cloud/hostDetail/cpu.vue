...
export default {
  ...
  data() {
    return {
      detailData: {},
      typeData: [{ title: 'CPU利用率', value: 'usage', expr: JSON.stringify(['round(vsphere_host_cpu_usage_average{cpu="instance-total",esxhostname="' + this.detailName + '"}, 0.01)']), name: '["cpu利用率"]', unit: '%' }],
      detailMapList: [
