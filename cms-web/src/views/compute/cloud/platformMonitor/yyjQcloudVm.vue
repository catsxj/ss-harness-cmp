  ...
  <div class="wrapper-container">
    <common-detail :title="$route.query.name" @goBack="goBack">
      <div slot="custom_content">
        <detail :detail-id="detailId" :identifier="identifier" :host-name="hostName" :bios-uuid="biosUuid" :instanceId="instanceId"></detail>
      </div>
    </common-detail>
  </div>
</template>
<script>
import detail from '../yyjqcloud/vm_detail.vue'
