...
<script>
import overview from '../openstack/host_overview.vue'
import cpu from '../openstack/host_cpu.vue'
import mem from '../openstack/host_memory.vue'
import disk from '../openstack/host_disk.vue'
import net from '../openstack/host_network.vue'
import { getOpenstackHost } from 'services/monitor'
export default {
  components: {
    overview,
    cpu,
  ...
  methods: {
    ...
    getOverview() {
      getOpenstackHost(this.detailId).then((data) => {
        if (data.success) {
