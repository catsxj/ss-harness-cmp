...
>
> **⚠️ 2026-04-22 变更**：csc-web（Vue 2，1,211 .vue）已决定**不迁移 + 移出本仓库**单独维护。
> 下文对 csc-web 的各类分析、时间线、并行度估算保留作历史参考，但**不再执行**。
> 本仓库迁移范围：scr-web（已完成）/ sms-web（已完成）/ cmp-web / cms-web / cos-web。
