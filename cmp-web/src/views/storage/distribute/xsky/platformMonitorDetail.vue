      ...
      <el-row class="m-t-xs" :gutter="5">
        <el-col :span="10">
          <el-card class="box-card">
            ...
            <pie-charts ref="chart1" v-if="chart1Data" id="chart1" :data="chart1Data" width="100%" :setting="{ color: ['#f11818', '#f56c19', '#5D59B4'] }" height="250px" theme="当前告警统计"></pie-charts>
          </el-card>
        </el-col>
        <el-col :span="14">
          <el-card class="box-card">
            ...
            <div>
              <bar-charts ref="chart2" height="250px" width="100%" id="cpu" :data="chart2Data" :setting="{ color: ['#f11818', '#f56c19', '#5D59B4'] }" v-if="chart2Data"></bar-charts>
            </div>
          </el-card>
        </el-col>
      </el-row>
