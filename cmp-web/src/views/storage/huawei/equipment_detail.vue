...
export default {
  ...
  methods: {
    ...
    getSecondChart() {
      const str1 = 'bocloud_smis_totalIOs{instanceUuid ="' + this.detailUuid + '",instanceType="storage"}'
      const str2 = 'bocloud_smis_readIOs{instanceUuid ="' + this.detailUuid + '",instanceType="storage"}'
      const str3 = 'bocloud_smis_writeIOs{instanceUuid ="' + this.detailUuid + '",instanceType="storage"}'
    ...
    getThirdChart() {
      const str1 = 'bocloud_smis_totalIOt{instanceUuid = "' + this.detailUuid + '",instanceType="storage"}'
      const str2 = 'bocloud_smis_readIOt{instanceUuid = "' + this.detailUuid + '",instanceType="storage"}'
      const str3 = 'bocloud_smis_writeIOt{instanceUuid = "' + this.detailUuid + '",instanceType="storage"}'
      const expr = JSON.stringify([str1, str2, str3])
      getCharts({
    ...
    getFourthChart() {
      const str1 = 'bocloud_smis_totalKB{instanceUuid = "' + this.detailUuid + '",instanceType="storage"}'
      const str2 = 'bocloud_smis_readKB{instanceUuid = "' + this.detailUuid + '",instanceType="storage"}'
      const str3 = 'bocloud_smis_writeKB{instanceUuid = "' + this.detailUuid + '",instanceType="storage"}'
      const expr = JSON.stringify([str1, str2, str3])
      getCharts({
    ...
    getFifthChart() {
      const str1 = 'bocloud_smis_readHit{instanceUuid = "' + this.detailUuid + '",instanceType="storage"}'
      const str2 = 'bocloud_smis_writeHit{instanceUuid = "' + this.detailUuid + '",instanceType="storage"}'
