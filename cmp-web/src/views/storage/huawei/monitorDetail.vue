      ...
      <el-row class="m-t-xs" :gutter="5">
        <el-col :span="10">
          <el-card class="box-card">
            ...
            <pie-charts ref="chart1" v-if="chart1Data" id="chart1" :data="chart1Data" width="100%" :setting="{ color: ['#EC1C24', '#FF7F27', '#FFF200', '#4EAFF5'] }" height="250px" theme="当前告警统计"></pie-charts>
          </el-card>
        </el-col>
        <el-col :span="14">
          <el-card class="box-card">
...
<script>
import currentMonitor from '../../compute/cloud/vcenter/currentMonitor.vue'
import historyMonitor from '../../compute/cloud/vcenter/historyMonitor.vue'
