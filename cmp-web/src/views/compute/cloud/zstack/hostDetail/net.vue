    ...
    return {
      typeData: [
        ...
        // }
        {
          title: '接收数据流量',
          value: 'netin',
          expr: JSON.stringify(['round(bocloud_zstack_host_net_in_bytes_rate{instance_id="' + this.uuid + '"},0.01)']),
          name: '["接收数据流量"]',
          unit: 'KB/s'
        },
        {
          title: '发送数据流量',
          value: 'netout',
          expr: JSON.stringify(['round(bocloud_zstack_host_net_out_bytes_rate{instance_id="' + this.uuid + '"},0.01)']),
          name: '["发送数据流量"]',
          unit: 'KB/s'
        }
      ],
