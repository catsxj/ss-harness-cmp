...
<script>
import overview from '../FusionCloud/vm_overview.vue'
import cpu from '../FusionCloud/vm_cpu.vue'
import mem from '../FusionCloud/vm_memory.vue'
import cloudDisk from '../FusionCloud/vm_cloud_disk.vue'
import net from '../FusionCloud/vm_net.vue'
export default {
  components: {
    overview,
    cpu,
