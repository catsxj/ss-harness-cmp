...
export default {
  ...
  data() {
    return {
      detailData: {},
      typeData: [{ title: 'CPU利用率', value: 'usage', expr: JSON.stringify(['round(yyjqcloud_host_cpu_usage{instance_id="' + this.instanceId + '",vendor_id="' + this.vendorId + '"}, 0.01)']), name: '["cpu利用率"]', unit: '%' }],
      detailMapList: [
