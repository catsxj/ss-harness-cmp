...
export default {
  ...
  data() {
    return {
      typeData: [{ title: '内存利用率', value: 'usage', expr: JSON.stringify(['round(bocloud_cloudtower_host_host_memory_usage_percent{instanceId="' + this.uuid + '"}, 0.01)']), name: "['内存利用率']", unit: '%' }],
      detailData: {},
      detailMapList: [
