...
export default {
  ...
  data () {
    return {
      detailData: {},
      typeData: [
        { title: 'CPU利用率', value: 'usage', expr: JSON.stringify(['round(bocloud_fusionsphere_host_cpu_usage{vendorId="' + this.detail.vendorId + '",instance_id="' + this.detail.uuid + '"}, 0.01)']), name: '["cpu利用率"]', unit: '%' }
      ],
      detailMapList: [
