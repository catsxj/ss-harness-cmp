<template>
  <el-dialog class="member_addDialog" title="成员配置" width="700px" :close-on-click-modal="false" :visible.sync="config.visibility">
    <div>
      <el-row>
    ...
    <div slot="footer" class="dialog-footer">
      <el-button type="ghost" @click.native="config.visibility = false">取消</el-button>
