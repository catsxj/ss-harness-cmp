...
export function billList(params) {
  return request.get('/cos/v1/pc/bills', { params })
}

export function exportBill(id) {
  downloadFile(`/cos/v1/pc/bills/${id}/download`)
}

export function exportBillTemplate(params) {
  downloadFile('/cos/v1/pc/bills/import/template', params)
}

export function getBillInstance(params) {
  return request.patch(`/cos/v1/pc/bills/${params.propertyId}/columns`, wrapperParams(params))
}

export function getBillingDetails(params, id) {
  return request.get(`/cos/v1/pc/bills/${id}`, { params })
}

export function removeBill(id) {
  return request.delete(`/cos/v1/pc/bills/${id}`)
}

export function mergeBill(params) {
  return request.post('/cos/v1/pc/bills/combine', wrapperParams(params))
}
...
export function createVpcCidr(id, params) {
  return request.put(`${vpcUrl}/${id}/add/address/space`, wrapperParams(params))
}
export function removeVpcCidr(id, params) {
  return request.put(`${vpcUrl}/${id}/remove/address/space`, wrapperParams(params))
}
export function createVpcDns(id, params) {
  return request.put(`${vpcUrl}/${id}/dns/server`, wrapperParams(params))
}
...
export function getVendorType(params) {
  return request.get('/sms/v1/vendors/condition', {
    params
  })
}
...
export function patchCloudVendorExcessRatio(params) {
  return request.patch(`${cloudVendorUrl}/${params.id}/excessRatio`, { ...wrapperParams(params) })
}
...
export function cluterUnBindVm(params) {
  return request.delete(`${clutersUrl}/${params.id ? params.id : params.clusterId}/hosts`, { data: wrapperParams(params) })
}
...
export function getFolders(params) {
  return request.get('/ims/v1/folder', {
    params: params
  })
}
// 硬盘类型
...
export function removeFirewallRules(params) {
  return request.delete(firewalRulelUrl, { data: wrapperParams(params) })
}
...
export function removeFirewallPolicys(params) {
  return request.delete(firewalPolicyUrl, { data: wrapperParams(params) })
}
...
export function removeQosPolicys(params) {
  return request.delete(qosPolicyUrl, { data: wrapperParams(params) })
}
...
export function removeFlavors(params) {
  return request.delete(flavorUrl, { data: params })
}
...
// 阿里云red
const aliRdsUrl = '/ims/v1/rds/pc/instances'
export function getAliRds(params) {
  return request.get(aliRdsUrl, {
    params
  })
}

export function patchAliRds(id) {
  return request.patch(`${aliRdsUrl}/${id}`)
}

export function removeAliRds(id) {
  return request.delete(`${aliRdsUrl}/${id}`)
}

export function detailAliRds(id) {
  return request.get(`${aliRdsUrl}/${id}`)
}
...
export function removeLbs(params) {
  return request.delete(lbUrl, { data: wrapperParams(params) })
}
...
export function removeLbListens(params) {
  return request.delete(lbLintenUrl, { data: wrapperParams(params) })
}
...
export function removeNetworks(params) {
  return request.delete(networkUrl, { data: wrapperParams(params) })
}
...
export function getVcTask(params) {
  return request.get(`/ims/v1/task-message/${params.id}`, { params: params.params })
}

export function getAlarams(params) {
  return request.get('/ims/v1/alarms', {
    params
  })
}
...
export function getVmTop(params) {
  return request.get('/cos/v1/reports/vms/top', { params: wrapperParams(params) })
}

export function checkStatus() {
  return request.get('/cos/v1/reports/vms/top/status')
}

export function handleRetry(params) {
  return request.put('/cos/v1/reports/vms/top/reset', wrapperParams(params))
}

export function statementList(params) {
  return request.get('/cos/v1/reports/vms', { params })
}
export function configTemplates(params) {
  return request.put('/cos/v1/reports/templates', wrapperParams(params))
}
export function selfTemplates(params) {
  return request.post('/cos/v1/reports/templates', wrapperParams(params))
}
export function removeTemplate(id) {
  return request.delete(`/cos/v1/reports/templates/${id}`)
}
export function selfTemplateList(params) {
  return request.get('/cos/v1/reports/templates', { params })
}
export function configTemplateDetail(id, params) {
  return request.get(`/cos/v1/reports/templates/vm/${id}`, { params: wrapperParams(params) })
}
export function getHistory(params) {
  return request.get('/cos/v1/reports', { params })
}
export function delHistory(id) {
  return request.delete(`/cos/v1/reports/${id}`)
}
export function historyMonitor(id) {
  return request.get(`/cos/v1/reports/vms/history/${id}`)
}

// export function selfTemplates() {
...
export function removeVmUsers(params) {
  return request.delete(`${vmUrl}/users`, {
...
export function removeHost(id, type) {
  return request.delete(`${hostUrl}/${id}`, { params: { type: type || 'Host' } })
}
...
export function patchVapp(action, params) {
  return request.patch(`${vappsUrl}/${params.id}`, {
    action: action,
    ...wrapperParams(params)
  })
}
...
export function modifyLibraryAccounts(params) {
  return request.get(`${libraryUrl}/item/${params.id}/accounts`, {
    params
  })
}
// 金山回归接口
...
export function removeVpcUsers(id) {
  return request.delete(`/ims/v1/vpcs/${id}/tenants`)
}
