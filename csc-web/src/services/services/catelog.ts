...
export function modifyFlowBindConfigNew(id: number, params: any) {
  return request.put(`${flowBindConfigUrl}/${id}`, params)
}
...
export function getTenantServicesItems(tenantId: any) {
  return request.get(`/cos/v1/services/tenants/${tenantId}/services/items`)
}
