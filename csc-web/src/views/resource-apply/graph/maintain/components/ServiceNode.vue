    ...
    <el-row>
      ...
      <el-col :span="12">
        <el-form-item label="操作：" prop="state">
          <el-select filterable clearable v-model="itemData.state" placeholder="请选择操作">
    ...
    <el-row>
      ...
      <el-col :span="12">
        <el-form-item v-if="itemData.osCategory === 'Linux'" label=" 开机自启动：">
          <el-select filterable clearable v-model="itemData.enabled" placeholder="请选择">
        ...
        <el-form-item v-else label="启动参数：">
          <el-select filterable clearable v-model="itemData.start_mode" placeholder="请选择">
            <el-option v-for="(item, index) in enabledData" :key="index" :label="item.name" :value="item.value"></el-option>
          </el-select>
        </el-form-item>
      </el-col>
