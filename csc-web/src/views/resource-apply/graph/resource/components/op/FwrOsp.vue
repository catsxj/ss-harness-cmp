      ...
      <div v-if="itemData.origin === 'create'">
        ...
        <el-col :span="24">
          <basic-form-item label="协议：" prop="protocol" validate="required">
            <el-select filterable v-model="itemData.protocol" :disabled="isPreview">
        ...
        <el-col :span="24">
          <basic-form-item label="动作：" prop="action" validate="required">
            <el-select filterable v-model="itemData.action" :disabled="isPreview">
        ...
        <el-col :span="24">
          <basic-form-item label="IP版本">
            <el-select filterable v-model="itemData.ipVersion" @change="setVersion" :disabled="isPreview">
