<template>
  <div>
    <basic-form-item label="数据盘：" class="m-b-lg">
      <el-row>
        <el-col :span="21" v-for="(cell, index) in addData.configs.dataDisk" :key="index" class="m-t">
          ...
          <el-input-number type="number" class="w" v-model="cell.dataDiskSize" :min="cell.min" :max="cell.max" :precision="0" :step="10"> </el-input-number>
