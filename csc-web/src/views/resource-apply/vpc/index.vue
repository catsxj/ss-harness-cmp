...
<template>
  <div>
    ...
    <easy-stack :type="type" v-if="type == 'EASYSTACK'" @type="setType" :item-data="itemData" :disabled="disabled" ref="node"></easy-stack>
...
export default {
  ...
  components: { ali, op, huawei, tencent, aws, tce, azure, easyStack },
  data() {
    return {
      type: ''
    }
