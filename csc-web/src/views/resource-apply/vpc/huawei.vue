        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <basic-form-item label="cidr: " prop="cidr" validate="required,cidr">
              <el-input v-model="addData.configs.cidr" class="basic-cmp"></el-input>
              <div class="mine-text">建议使用网段：10.0.0.0/8-24,172.16.0.0/12-24,192.168.0.0/16-24</div>
            </basic-form-item>
          </el-col>
        </el-row>
      </div>
      ...
      elements: [
        {
          ...element,
          name: 'VPC',
          serviceCode: 'huawei.standard.vpc',
          main: true
        }
      ],
      addData: {
