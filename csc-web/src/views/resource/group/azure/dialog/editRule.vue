<template>
  <div>
    <el-dialog title="修改安全组规则" :visible.sync="addData.dialog" width="70%" top="7vh">
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item>
              ...
              <el-select v-model="addData.sourceType">
          ...
          <el-col :span="8">
            <el-form-item prop="sourceAddressPrefix" :rules="rules" v-if="addData.sourceType == 'ip'" key="sourceAddressPrefix">
              <span slot="label">
                源地址：
              ...
              <el-input v-model="addData.data.sourceAddressPrefix" placeholder="10.0.0.0/16"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="目标：">
              ...
              <el-select v-model="addData.destination">
                <el-option label="Any" value="Any"></el-option>
                <el-option label="IP Addresses" value="ip"></el-option>
              </el-select>
            </el-form-item>
          ...
          <el-col :span="8">
            <el-form-item prop="destinationAddressPrefix" :rules="rules" v-if="addData.destination == 'ip'" key="destinationAddressPrefix">
              <span slot="label">
                目的地址：
                <el-tooltip class="item" effect="dark" content="提供采用 CIDR 表示法的地址范围(例如 192.168.99.0/2)或提供 IP 地址(例如 192.168.99.0)" placement="top-start">
                  <i class="el-icon-question"></i>
              ...
              <el-input v-model="addData.data.destinationAddressPrefix" placeholder="10.0.0.0/16"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
...
<script>
import { modifyGroupRule } from 'services/platform/index'
      ...
      this.$refs.addData.validate(valid => {
        if (valid) {
          ...
          modifyGroupRule({
            ...
            direction: this.addData.data.direction,
            protocol: this.addData.data.protocol,
            vendorId: this.addData.data.vendorId,
            groupId: this.addData.data.groupId,
            remoteIpPrefix: this.addData.data.remoteIpPrefix,
            priority: this.addData.data.priority,
            action: this.addData.data.action,
            name: this.addData.data.name,
            sourceAddressPrefix: this.addData.sourceType == 'Any' ? 'Any' : this.addData.data.sourceAddressPrefix.split(','),
            destinationAddressPrefix: this.addData.destination == 'Any' ? 'Any' : this.addData.data.destinationAddressPrefix.split(','),
