<template>
  <basic-form ref="addData" :model="addData" :status-icon="true" label-width="100px">
    ...
    <basic-form-item label="起始端口：" prop="portMin" validate="required,postInteger" v-if="addData.protocol != 'ICMP'">
      <el-input v-model.number="addData.portMin"></el-input>
    </basic-form-item>
    <basic-form-item label="结束端口：" prop="portMax" validate="required,postInteger" v-if="addData.protocol != 'ICMP'">
      <el-input v-model.number="addData.portMax"></el-input>
    </basic-form-item>
    <basic-form-item label="CIDR：" prop="remoteIpPrefix">
