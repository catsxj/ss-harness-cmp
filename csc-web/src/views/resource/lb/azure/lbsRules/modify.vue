<template>
  <div>
    <el-dialog append-to-body title="修改负载均衡规则" :visible.sync="addData.dialog" v-if="addData.dialog">
...
<script>
/* global $ */
import { modifyLbRules, getFrontends, getProbes, getBackends } from 'services/platform/azure'
export default {
  props: {
    addData: {
      type: Object,
  ...
  methods: {
    ok() {
      this.$refs.data.validate(valid => {
        if (valid) {
          modifyLbRules(this.addData.data.id, {
