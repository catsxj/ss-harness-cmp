<template>
  <el-dialog title="手机验证" :visible.sync="addData.dialog" width="50%" append-to-body>
    <basic-form ref="data1" :model="addData.data" label-width="120px" @submit.native.prevent>
      <basic-form-item label="你绑定的手机：">
        <el-row>
          <el-col :span="15">
            {{ userData.phone.substr(0, 3) + '****' + userData.phone.substr(7) }}
          </el-col>
        </el-row>
      </basic-form-item>
      <codes :add-data="addData.data"></codes>
    </basic-form>
