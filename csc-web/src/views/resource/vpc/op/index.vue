<template>
  <div class="wrapper">
    <el-form :inline="true">
      <el-form-item>
        <router-link :to="{ name: 'ServiceVpcCreate', params: { type: 'OPENSTACK' } }" class="m-l-xs">
    ...
    <basic-table :data="vpcList" :params="params" :get-list="getList" :total="total">
      ...
      <el-table-column label="操作" width="220px">
        <template slot-scope="scope">
          ...
          <UnsubscribeService type="vpc" :data="scope.row" @getList="getList"> </UnsubscribeService>
        </template>
      </el-table-column>
    </basic-table>
...
export default {
  components: { UnsubscribeService, DelayService, SubnetList },
  mixins: [webSocket],
  data() {
    return {
