<template>
  <div>
    ...
    <modify-port :add-data="modifyPortData" v-if="modifyPortData.dialog"></modify-port>
    <add-subnet @back="getSubnet" :add-data="addSubnetData" v-if="addSubnetData.dialog"></add-subnet>
    <add-port :add-data="addPortData" v-if="addPortData.dialog"></add-port>
  </div>
</template>

<script>
import modifyPort from './modifyPort.vue'
