<template>
  <div>
    <basic-form-item label="可用地域" prop="regionId" validate="required">
      <el-select v-model="addData.regionId" placeholder="请选择地域" :disabled="addData.title === '编辑'" validate="required">
    ...
    <el-form-item label="读取文件" v-if="way == 'daoru'" required>
