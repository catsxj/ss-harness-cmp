<template>
  <div>
    <el-dialog title="重设主机密码" width="40%" :close-on-click-modal="false" v-if="addData.dialog" :visible.sync="addData.dialog">
      <el-form :model="addData.data" :rules="rules" status-icon ref="data" label-width="120px" class="demo-ruleForm">
        <el-alert class="m-b-md" title="机器密码需8到26位，至少包括三项（[a-z,A-Z],[0-9]和[()`~!@#$%^&*-+=_|{}[]:;',.?/])的特殊符号" type="warning"> </el-alert>
