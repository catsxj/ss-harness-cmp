...
import '../index.scss'
export default {
  components: { headerContent, addImage, res, detailMsg, Upgrade, group, volume, bindIp, modifyPas, AddDisk, dilatation },
  props: {
    detail: {
      type: Object,
      default: function () {
  ...
  methods: {
    ...
    onmessage(data) {
      if (data.operate.indexOf('vm') > -1 || data.operate.indexOf('qcloud') > -1 || data.operate.indexOf('resource') > -1) {
    ...
    upgradeSpec() {
      ...
      this.upgradeDialog = {
        ...
        data: {
          ...this.detail,
          flavorId: '', // 暂时不做回显
          service: 'qcloud.standard.server',
          // 用来获取规格接口传参
          params: {
    ...
    addDisk() {
      ...
      this.addDiskData = {
        ...
        data: {
          ...
          service: 'qcloud.standard.server',
          params: {
            serviceCode: 'qcloud.standard.volume',
