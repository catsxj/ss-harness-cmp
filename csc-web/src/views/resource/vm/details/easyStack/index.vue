        ...
        <el-col :span="24">
          ...
          <el-dropdown style="margin-left: 10px">
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item  @click.native="setQos">设置QOS</el-dropdown-item>
            ...
            <el-row :gutter="5">
              ...
              <el-col :span="14">
                <el-card class="m-t" :body-style="{ padding: 0 }">
                  ...
                  <el-table :data="networks" border style="width: 100%">
...
export default {
  components: { Upgrade, snapshot, res, modifyPas, breakdown, setQos, group, volume, detailMsg, modifyIp, bindIp, mount, unMount, addSnapshot, online, offline, monitor },
  props: {
    detail: {
      type: Object,
      default: function () {
