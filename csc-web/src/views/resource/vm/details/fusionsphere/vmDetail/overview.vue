  ...
  <div>
    ...
    <el-row :gutter="5">
      <!-- <el-col :span="24">
         ...
         <el-col :span="12">
          <el-card class="box-card m-t-xs" style="height:297px;">
...
export default {
    ...
    return {
      typeData: [
        ...
        },
        {
          ...
          value: 'disk',
          expr: JSON.stringify([
            // 'round(vsphere_vm_disk_usage_average{disk="instance-total",vmname="' + this.identifier + '",esxhostname="' + this.hostName + '"},0.01)'
            'round(bocloud_fusionsphere_vm_disk_usage{vendorId="' + this.detail.vendorId + '",instance_id="' + this.detail.instanceId + '"},0.01)'
          ]),
          name: '["磁盘利用率"]',
          unit: '%'
        },
        {
          ...
          value: 'mem',
          expr: JSON.stringify([
            // 'round(vsphere_vm_mem_usage_average{vmname="' + this.identifier + '",esxhostname="' + this.hostName + '"},0.01)'
            'round(bocloud_fusionsphere_vm_mem_usage{vendorId="' + this.detail.vendorId + '",instance_id="' + this.detail.instanceId + '"},0.01)'
          ]),
          name: '["内存利用率"]',
          unit: '%'
        }
  ...
  methods: {
    ...
    getDashboard () {
      ...
      const expr1 = 'round(bocloud_fusionsphere_vm_cpu_usage{vendorId="' + this.detail.vendorId + '",instance_id="' + this.detail.instanceId + '"},0.01)'
      // const expr2 = 'round(vsphere_vm_mem_usage_average{vmname="' + this.identifier + '",esxhostname="' + this.hostName + '"},0.01)'
      const expr2 = 'round(bocloud_fusionsphere_vm_mem_usage{vendorId="' + this.detail.vendorId + '",instance_id="' + this.detail.instanceId + '"},0.01)'
      getHostDashboard({
        expr: expr1,
        simple: true
      }).then(data => {
