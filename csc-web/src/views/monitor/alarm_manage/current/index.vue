    ...
    <div>
      <el-form :inline="true">
        ...
        <el-form-item>
          ...
          <el-button type="ghost" @click="handleBatchClear()" :disabled="!this.selectList.length"> 批量清除 </el-button>
        </el-form-item>
      </el-form>
      <basic-table :data="tableData" :params="params" :get-list="getList" :total="total" @select="handleSelectItem" @select-all="handleSelectAll" ref="currentMonitorTable">
        ...
        <el-table-column label="操作" width="160px">
          <template slot-scope="scope">
            ...
            <el-button type="text" @click="handleClear(scope.row.id)" :disabled="scope.row.solved"> <i class="el-icon-delete"></i> 清除 </el-button>
          </template>
        </el-table-column>
      </basic-table>
    </div>
...
<script>
import { getAlarmList, getAlarmDetail, alarmConfirm, alarmSolve } from 'services/monitor'
