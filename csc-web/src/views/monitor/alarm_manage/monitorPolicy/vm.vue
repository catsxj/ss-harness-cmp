  ...
  <div>
    ...
    >
      ...
      <template #os="val, record">
        <div v-if="record.vendorType == 'VMWARE' || record.vendorType == 'INSPURRAIL' || record.vendorType == 'TIANYI' || record.vendorType == 'HUAWEI'">
    ...
    return {
      ...
      searchConfigs: [
        ...
        { type: 'Const', value: 'id', initValue: this.resourceIds && this.status == 'detail' ? this.resourceIds.join(',') : '', sign: 'IN' },
        {
          type: 'Const',
          value: 'isTemplate',
          initValue: getVendorType(this.resourceType) == 'VMWARE' || getVendorType(this.resourceType) == 'INSPURRAIL' || getVendorType(this.resourceType) == 'H3C' || getVendorType(this.resourceType) == 'SMARTX' || getVendorType(this.resourceType) == 'CLOUDTOWER' ? false : ''
        }
      ],
      list: [],
      total: 0,
