    ...
    <div>
      <div v-for="item in list" :key="item.name" class="m-b-md">
        ...
        <basic-table :data="item.value">
          ...
          <el-table-column label="申请时长（天）" prop="applyLength"></el-table-column>
          <el-table-column label="创建时间" prop="gmtCreate"></el-table-column>
          <el-table-column label="计算资源" prop="cloudServerCount"></el-table-column>
          <el-table-column label="下级租户数" prop="parentIdNumber"></el-table-column>
          <el-table-column label="用户数量" prop="userNumber"></el-table-column>
          <el-table-column :label="$store.getters.systemConfig.projectConfigLabel + '数量'" prop="projectNumber"></el-table-column>
