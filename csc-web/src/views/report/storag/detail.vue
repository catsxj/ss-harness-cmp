    ...
    <div>
      <div v-for="item in list" :key="item.name" class="m-b-md">
        ...
        <basic-table :data="item.value">
          ...
          <el-table-column label="健康状态" prop="status"></el-table-column>
          <el-table-column label="容量大小(GB)" prop="diskTotal"></el-table-column>
          <el-table-column label="控制节点数" prop="monCount"></el-table-column>
          <el-table-column label="存储节点数" prop="osdCount"></el-table-column>
