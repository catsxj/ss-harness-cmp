      ...
      <el-col :span="12">
        <el-card style="height: 408px">
          <div slot="header">
            ...
            <el-button type="danger" size="mini" @click="removeUser" :disabled="rightSlection.length === 0"> <i class="el-icon-arrow-right"></i> 移除</el-button>
          </div>
...
<script>
import { getUser, getUserDetail } from 'services/system/user'
