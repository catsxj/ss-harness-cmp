<template>
  <PageLayout title-name="流程编排" @goBack="goBack">
    <span slot="operate" class="pull-right m-r-lg">
...
<script>
import Editor from './flowEdit/create'
  ...
  methods: {
    ...
    handlePostData() {
      ...
      for (const node of data.nodes) {
        const { label: name, code: type, x, y, shape, color, size, index, id, assignee, assigneeRole, assigneeTenantAdmin, assigneeProjectManager, autoExecute } = node
