...
<script>
import addSubnet from './op/addSubnet.vue'
import { removePort, removePorts, getSubnet, createSubnet, removeSubnet, detailSubnet, removeSubnets, getNetwork, removeNetwork, detailNetwork, removeNetworks } from 'services/platform/index'
export default {
  components: {
    addSubnet
  },
