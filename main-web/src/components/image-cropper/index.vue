...
export default {
  ...
  methods: {
    ...
    upload() {
      const that = this
      const { lang, imageFormat, mime, url, params, headers, field, ki, createImgUrl, withCredentials } = this
      const fmData = new FormData()
      fmData.append(field, data2blob(createImgUrl, mime), field + '.' + imageFormat)
