...
export function exportCpuList(params) {
  downloadFile('/ims/v1/spec/cpu/export', params)
}
...
export function exportMemoryList(params) {
  downloadFile('/ims/v1/spec/mem/export', params)
}
...
export function exportDiskList(params) {
  downloadFile('/ims/v1/spec/disk/export', params)
}
...
export function exportPartsList(params) {
  downloadFile('/ims/v1/spec/parts/export', params)
}
...
export function exportServerList(params) {
  downloadFile('/ims/v1/spec/server/export', params)
}
