        ...
        <el-row :gutter="20" v-else-if="addData.configs.disktype == '卷'" key="2">
          <el-col :span="10">
            <basic-form-item label="选择卷：" prop="sourceValidId" validate="required">
              <el-select v-model="addData.configs.sourceValidId" @change="changeVolumeSize">
        ...
        <el-row :gutter="20" v-else-if="addData.configs.disktype == '快照'" key="3">
          <el-col :span="10">
            <basic-form-item label="选择快照：" prop="sourceSnapId" validate="required">
              <el-select v-model="addData.configs.sourceSnapId" @change="changeSnapshotSize">
  ...
  data() {
    return {
      ...
      addData: {
        ...
        service: 'smartx.standard.volume',
        configs: {
          resourceLabel: [],
          diskCategoryId: 0,
          sourceImgId: '',
