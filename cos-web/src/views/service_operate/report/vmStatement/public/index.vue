<template>
  <el-tabs ref="resourceMonitorTab" @tab-click="handleClick" v-model="activeName" type="border-card">
    ...
    <history-monitor :monitor="monitor"></history-monitor>
  </el-tabs>
</template>
...
import { statementList, removeTemplate, selfTemplateList, getHistory, configTemplateDetail, delHistory } from 'services/platform/index'
