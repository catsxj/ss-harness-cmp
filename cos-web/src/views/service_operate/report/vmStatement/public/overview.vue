        ...
        <el-card class="m-b-sm">
          <div slot="header">
            ...
            <span class="pull-right">
              <el-button-group>
                <el-button size="mini" :type="item.measure == CpuDay.measure ? 'primary' : ''" v-for="item in intervalData" :key="item.measure" @click="changeInterval(item.measure, 'Cpu', 'ByDay', '云主机cpu利用率', 'topCpu', 'CpuDay')">{{ item.name }}</el-button>
              </el-button-group>
            </span>
          </div>
      ...
      <el-col :span="8">
        <el-card class="m-b-sm">
          <div slot="header">
            ...
            <span class="pull-right">
              <el-button-group>
                <el-button size="mini" :type="item.measure == MemDay.measure ? 'primary' : ''" v-for="item in intervalData" :key="item.measure" @click="changeInterval(item.measure, 'Mem', 'ByDay', '云主机内存利用率', 'topMem', 'MemDay')">{{ item.name }}</el-button>
              </el-button-group>
            </span>
          </div>
      ...
      <el-col :span="8">
        <el-card class="m-b-sm">
          <div slot="header">
            ...
            <span class="pull-right">
              <el-button-group>
                <el-button size="mini" :type="item.measure == DiskDay.measure ? 'primary' : ''" v-for="item in intervalData" :key="item.measure" @click="changeInterval(item.measure, 'Disk', 'ByDay', '云主机存储利用率', 'topDisk', 'DiskDay')">{{ item.name }}</el-button>
              </el-button-group>
            </span>
          </div>
      ...
      <el-col :span="8">
        <el-card class="m-b-sm">
          <div slot="header">
            ...
            <span class="pull-right">
              <el-button-group>
                <el-button size="mini" :type="item.measure == CpuWeek.measure ? 'primary' : ''" v-for="item in intervalData" :key="item.measure" @click="changeInterval(item.measure, 'Cpu', 'ByWeek', '云主机cpu利用率', 'weekTopCpu', 'CpuWeek')">{{ item.name }}</el-button>
              </el-button-group>
            </span>
          </div>
      ...
      <el-col :span="8">
        <el-card class="m-b-sm">
          <div slot="header">
            ...
            <span class="pull-right">
              <el-button-group>
                <el-button size="mini" :type="item.measure == MemWeek.measure ? 'primary' : ''" v-for="item in intervalData" :key="item.measure" @click="changeInterval(item.measure, 'Mem', 'ByWeek', '云主机内存利用率', 'weekTopMem', 'MemWeek')">{{ item.name }}</el-button>
              </el-button-group>
            </span>
          </div>
      ...
      <el-col :span="8">
        <el-card class="m-b-sm">
          <div slot="header">
            ...
            <span class="pull-right">
              <el-button-group>
                <el-button size="mini" :type="item.measure == DiskWeek.measure ? 'primary' : ''" v-for="item in intervalData" :key="item.measure" @click="changeInterval(item.measure, 'Mem', 'ByWeek', '云主机存储利用率', 'weekTopDisk', 'DiskWeek')">{{ item.name }}</el-button>
              </el-button-group>
            </span>
          </div>
      ...
      <el-col :span="8">
        <el-card class="m-b-sm">
          <div slot="header">
            ...
            <span class="pull-right">
              <el-button-group>
                <el-button size="mini" :type="item.measure == CpuMoth.measure ? 'primary' : ''" v-for="item in intervalData" :key="item.measure" @click="changeInterval(item.measure, 'Cpu', 'ByMonth', '云主机cpu利用率', 'mothCpu', 'CpuMoth')">{{ item.name }}</el-button>
              </el-button-group>
            </span>
          </div>
      ...
      <el-col :span="8">
        <el-card class="m-b-sm">
          <div slot="header">
            ...
            <span class="pull-right">
              <el-button-group>
                <el-button size="mini" :type="item.measure == MemMoth.measure ? 'primary' : ''" v-for="item in intervalData" :key="item.measure" @click="changeInterval(item.measure, 'Mem', 'ByMonth', '云主机内存利用率', 'mothMem', 'MemMoth')">{{ item.name }}</el-button>
              </el-button-group>
            </span>
          </div>
      ...
      <el-col :span="8">
        <el-card class="m-b-sm">
          <div slot="header">
            ...
            <span class="pull-right">
              <el-button-group>
                <el-button size="mini" :type="item.measure == DiskMoth.measure ? 'primary' : ''" v-for="item in intervalData" :key="item.measure" @click="changeInterval(item.measure, 'Disk', 'ByMonth', '云主机存储利用率', 'mothDisk', 'DiskMoth')">{{ item.name }}</el-button>
              </el-button-group>
            </span>
          </div>
...
export default {
  ...
  methods: {
    ...
    changeInterval(vmType, metric, period, name, type, val) {
      this[val].measure = vmType
      this.getData(vmType, metric, period, name, type)
    }
  }
}
</script>
