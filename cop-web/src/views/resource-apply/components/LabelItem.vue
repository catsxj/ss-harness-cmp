    ...
    <el-row :gutter="20" v-if="showInput">
      <el-col :span="6">
        <el-select v-model="addData.key" @change="setValue(addData)">
          <el-option v-for="(item1, index) in tagList" :key="index" :label="item1.name" :value="item1.name">
          </el-option>
        </el-select>
      </el-col>
      <el-col :span="6">
        <el-select v-model="addData.value">
          <el-option v-for="(item1, index) in addData.valueList" :key="index" :label="item1" :value="item1">
          </el-option>
        </el-select>
      </el-col>
      <el-col :span="8">
