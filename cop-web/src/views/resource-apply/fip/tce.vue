...
*/
<template>
  <common-wrapper code="network" :add-data="addData" ref="common" :elements="elements" :item-data="retention" :disabled="disabled" v-if="isLoadData">
  </common-wrapper>
</template>
