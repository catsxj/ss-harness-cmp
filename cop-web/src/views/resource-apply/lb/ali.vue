      ...
      <el-row :gutter="20">
        <el-col :span="24">
          ...
          <basic-form-item label="备可用区: " prop="availabilityZones[0].slave" required-message="请选择备可用区">
            <el-select v-model="addData.configs.availabilityZones[0].slave" filterable clearable>
          ...
          <basic-form-item label="规格: " prop="spec" validate="required,aliName">
            <el-select v-model="addData.configs.spec">
  ...
  methods: {
    ...
    getParams () {
      ...
      this.$refs.addForm.validate(valid => {
        if (valid) {
          this.addData.configs.availabilityZones[0].master = this.addData.location.region
          data = true
        }
      })
      return data;
