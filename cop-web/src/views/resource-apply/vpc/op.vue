  ...
  <common-wrapper :add-data="addData" vendorType="OPENSTACK" ref="common" :elements="elements" :showCount="false" :item-data="retention" :disabled="disabled" :getParams="getConfigs" v-bind="$attrs">
    ...
    <basic-form-item label="子网地址：">
      <el-radio-group v-model="addData.configs.subRadio">
        <el-radio :label="0">
          <el-input-number v-model="addData.configs.subNetwork[0][0]" class="w-xxs" disabled :controls="false"></el-input-number>.
          <el-input-number v-model="addData.configs.subNetwork[0][1]" class="w-xxs" disabled :controls="false"></el-input-number>.
          <el-input-number v-model="addData.configs.subNetwork[0][2]" :min="0" :max="255" class="w-xxs" :controls="false"></el-input-number>.
          <el-input-number v-model="addData.configs.subNetwork[0][3]" :min="0" :max="255" class="w-xxs" :controls="false"></el-input-number>/
        ...
        <el-radio :label="1" class="m-t">
          <el-input-number v-model="addData.configs.subNetwork[1][0]" class="w-xxs" disabled :controls="false"></el-input-number>.
          <el-input-number v-model="addData.configs.subNetwork[1][1]" class="w-xxs" :min="16" :max="255" :controls="false"></el-input-number>.
          <el-input-number v-model="addData.configs.subNetwork[1][2]" class="w-xxs" :min="0" :max="255" :controls="false"></el-input-number>.
          <el-input-number v-model="addData.configs.subNetwork[1][3]" :min="0" :max="255" class="w-xxs" :controls="false"></el-input-number>/
