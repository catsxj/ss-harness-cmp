        ...
        <el-col :span="12">
          <basic-form-item label="CIDR：">
            <el-select style="width: 100px" v-model="addData.configs.one" @change="oneChange">
              ...
              <el-option value="192"></el-option>
            </el-select >&nbsp;.&nbsp;
            <el-input-number :disabled="addData.configs.one === '192'" :title="'范围：' + addData.configs.twoMin + '-' + addData.configs.twoMax" v-model="addData.configs.two" :min="addData.configs.twoMin" :max="addData.configs.twoMax" style="width: 100px" :controls="false"></el-input-number>&nbsp;.&nbsp;0&nbsp;.&nbsp;0&nbsp;/&nbsp;
