  ...
  <common-wrapper code="compute" :add-data="addData" @vendorId="getList" @backZone="getSubnet" ref="common" :elements="elements" :get-params="getParams" :modify-element="modifyElement" :item-data="retention" :disabled="disabled">
    ...
    <el-col :span="6">
      <basic-form-item label="系统盘：" prop="configs.systemDiskCategory" validate="required" required-message="请选择系统盘类别">
        <el-select v-model="addData.configs.systemDiskCategory" placeholder="请先选择系统盘类别">
    ...
    <el-col :span="6" :offset="1">
      <basic-form-item label=" " prop="configs.systemDiskSize" label-width="25px" validate="required">
        <el-input-number v-model="addData.configs.systemDiskSize" :min="40" :max="500" style="width: 100%"> </el-input-number>
...
export default {
  ...
  methods: {
    handleShowData () {
      ...
      const { name, password, hasIpv6, networkId, subnetUuid, groups, manualIp, managerIp } = this.addData.configs
      this.vmData = {
        name: name,
        hasIpv6: hasIpv6,
        networkId: networkId,
