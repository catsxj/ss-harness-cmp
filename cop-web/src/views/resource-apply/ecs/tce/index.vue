...
<template>
  <common-wrapper code="compute" :add-data="addData" @vendorId="getList" @backZone="getSubnet" ref="common" :elements="elements" :modify-element="modifyElement" :get-params="getParams" :item-data="retention" :disabled="disabled">
    ...
    <images :add-data="addData.configs" :vendor-id="addData.location.vendorId" :location="addData.location" vendorType="TENCENT" :item-data="retention"></images>
    <el-col :span="6">
      <basic-form-item label="系统盘：" prop="configs.rootVolumeType" validate="required" required-message="请选择系统盘类别">
        ...
        <span class="remark_title">磁盘类型</span>
      </basic-form-item>
    </el-col>
    <el-col :span="6" :offset="1">
      <basic-form-item label=" " prop="configs.rootSize" label-width="25px" validate="required">
        ...
        <span class="remark_title">磁盘容量</span>
      </basic-form-item>
    </el-col>
...
export default {
  ...
  data () {
    return {
      elements: [{
        name: '云主机',
        serviceCode: 'tce.standard.server',
        main: true,
        cpu: 0,
        memory: 0
      }, {
        name: '云硬盘',
        serviceCode: 'tce.standard.volume',
        main: true,
        insAmount: 50
      }
      ],
