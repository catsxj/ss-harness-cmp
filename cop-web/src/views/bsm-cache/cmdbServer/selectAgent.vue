  ...
  <el-row :gutter="10">
    <el-col :span="24">
      <el-form-item label="服务器集：" class="m-b-sm">
        ...
        <el-button type="primary" v-if="agentType === 'agent'" size="small" class="pull-left" @click="selectCmdb">
          选择CMDB主机
        </el-button>
      ...
      <el-form-item>
        <div class="table-container">
          <el-table :data="itemData.hostList" class="target-table ag-table" header-cell-class-name="custom-header" stripe max-height="300">
            ...
            <el-table-column label="操作系统" prop="category"></el-table-column>
...
export default {
  components: {
    selectCmdbHost: () => import('views/bsm-cache/cmdbServer/selectHost'),
    selectAgentHost: () => import('views/bsm-cache/agentServer/selectHost')
  },
  props: {
    itemData: {
      type: Object
