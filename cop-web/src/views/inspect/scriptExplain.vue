...
1.输出一个巡检值value（支持字符串，数字，百分比）<br>
2.输出多个巡检值<br>
  多个巡检key-value之间||||分割<br>
  key和value之间====分割，key只支持字符串<br>
3.输出多组单个巡检值 <br>
  多组巡检结果之间@@@@分割<br>
  巡检分组名称和巡检数据之间++++分割<br>
4.输出多组多个巡检值  组合2和3两种情况<br>`
        },
        {
          key: 'inspect_info',
          name: '巡检检测详细数据',
          ...
          value: '|||| &nbsp;每项',
          required: '非必须',
          description: '巡检过程中的查询项目详细信息，如须输出到报告中<br>便于管理员查看，则在此输出'
        }
      ],
      explainList2: [
        {
        ...
        {
          key: '输出硬盘使用率和IO使用率',
          example: 'PERCENT====70%||||IO_PERCENT====70%',
          exp1: '【多值匹配】<br>硬盘使用率 PERCENT > 50% <br> IO使用率 IO_PERCENT >  50%'
        },
        {
          key: '输出多个挂载点的硬盘使用率',
          example: '/root++++70%@@@@/mnt++++70%',
          exp1: '【单值匹配】<br>  >  50%  '
        },
        {
          key: '输出多个挂载点的硬盘使用率和IO使用率',
          example: 'PERCENT====/root++++70%@@@@mnt++++60%||||IO_PERCENT====/root++++70%@@@@mnt++++60%',
          exp1: '【多值匹配】<br>硬盘使用率 PERCENT > 50% <br> IO使用率 IO_PERCENT >  50%'
        }
      ]
    }
