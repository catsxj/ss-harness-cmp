  ...
  <div>
            ...
            <el-row :gutter="10">
              <el-col :span="12">
                <basic-form-item label="主脚本：">
                  <el-switch v-model="item.runnable">
                  </el-switch>
                </basic-form-item>
              </el-col>
            </el-row>
    ...
    <el-dialog title="选择脚本" :visible.sync="dialogVisible" append-to-body v-if="dialogVisible">
      <basic-form :model='scripts[currentIndex]' ref="scriptForm">
        <select-script-item ref="scriptItem" :script-item="scripts[currentIndex]" class="text-left"><span v-if="isPreview || isTaskInstance"></span>
        </select-script-item>
      </basic-form>
