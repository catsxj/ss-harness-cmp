  ...
  <CardLayout title="成功条件">
    <basic-form :model="itemData" label-width="0" ref="form">
      <basic-table :data="itemData.conditions" class="target-table">
        <el-table-column label="节点名称" prop="name" width="80px" show-overflow-tooltip="">
        </el-table-column>
        <!--<el-table-column label="数据来源">-->
          <!--<template slot-scope="scope">-->
            <!--<el-select v-model="scope.row.source" :disabled="isPreview" @change="selectSource(scope.row, scope.$index)">-->
        ...
        <!--<el-table-column label="比较关系">-->
          <!--<template slot-scope="scope">-->
            <!--<basic-form-item class="m-b-none">-->
              <!--<el-select v-model="scope.row.relation" :disabled="isPreview || scope.row.source ===  'result'">-->
        ...
        <el-table-column label="执行结果">
          <template slot-scope="scope">
            <basic-form-item class="m-b-none" :prop="'conditions.'+scope.$index+'.value'" validate="required">
              <el-select v-model="scope.row.value" :disabled="isPreview">
        ...
        <el-table-column label="运算关系">
          <template slot-scope="scope">
            <basic-form-item class="m-b-none">
              <el-select v-model="scope.row.link" :disabled="isPreview">
