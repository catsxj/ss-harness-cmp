  ...
  <basic-form :model="itemData" ref="form"  :disabled="isPreview">
    ...
    <el-row>
      ...
      <el-col :span="24" class="title">
        创建用户 <el-button class="m-l" type="primary" size="mini"  @click="addUserItem(itemData.mongodb_users)">新增</el-button>
      </el-col>
    </el-row>
    <div v-for="(item, index) in itemData.mongodb_users" :key="index" class="search-container">
      ...
      <el-row>
        <el-col :span="12">
          <basic-form-item label="用户名：" :prop="'mongodb_users.'+index+'.name'"
                         validate="required">
